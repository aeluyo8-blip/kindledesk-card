...
扩展脚本和 daemon 代码见 [KindleDesk 主仓库](https://github.com/aeluyo8-blip/kindledesk)。
...
```bash
# 克隆 KindleDesk 主仓库并启动 daemon
git clone https://github.com/aeluyo8-blip/kindledesk.git
cd kindledesk
pip install pillow
...
Kindle 越狱、KUAL 扩展部署和 daemon 配置的完整文档见 [KindleDesk 主仓库](https://github.com/aeluyo8-blip/kindledesk) 的 `flows/` 目录。
